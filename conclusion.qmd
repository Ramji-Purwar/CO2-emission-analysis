...
All five core arguments in this analysis were subjected to formal hypothesis testing.
Every hypothesis was rejected at p << 0.05, providing rigorous statistical backing
for the narrative presented across chapters.

| Hypothesis | Test | p-value |
|---|---|---|
| [H1: Carbon Leakage](hypotheses.qmd) | Paired t-test | 7.8e-04 |
| [H2: Decoupling](hypotheses.qmd) | Wilcoxon signed-rank | 7.1e-22 |
| [H3: Coal Intensity](hypotheses.qmd) | Mann-Whitney U | 8.1e-06 |
| [H4: Historical Responsibility](hypotheses.qmd) | Spearman correlation | 6.2e-62 |
| [H5: Per-Capita Equity](hypotheses.qmd) | Mann-Whitney U | 1.1e-14 |
